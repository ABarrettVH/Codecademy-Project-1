...
def direction9d():
    direction = input("\nYou plod on around the corner. You can hear a soft singing ahead of you. Do you follow the singing forward\
or take the path to your right?\n ")
